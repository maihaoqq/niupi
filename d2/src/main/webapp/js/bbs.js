$(document).ready(function(){
	   ...
	   */
	   $.ajax({  
	   	type: "get",  
			...
			success: function (res) {
				...
				var i = 0;
				for( i = 0; i < len; i++){
					$('.left-content .content ul').append('<li class="clearfix"><div class="icon fl"><a href="javascript:void(0);"><img src='+res.item[i].img+' id='+res.item[i].user_mes.id+'></a></div><div class="fl"><div class="clearfix tt"><span class="nor fl">'+res.item[i].topic+'</span><a class="title fl" href="#">'+res.item[i].tt+'</a></div><div class="txt"><p><span class="w">'+res.item[i].user_name+'</span>&nbsp;发表于：<span class="time">'+res.item[i].start_time+'</span>&nbsp;最新回复：<span class="new">'+res.item[i].lastest_time+'</span></p></div></div><div class="fr mt-10 mr-10"><span class="comment">'+res.item[i].comment+'</span></div><div style="display: none;" class="tooltip"><div id='+"tooltip"+i+'><div class="clearfix"><div class="img-box fl"><img src='+res.item[i].img+' id='+res.item[i].user_mes.id+'><div class="talk clearfix"><a class="fl add-btn">+添加</a></div></div><div class="h-102 fl"><p class="name">'+res.item[i].user_mes.name+'</p><p class="school">'+res.item[i].user_mes.school+'</p><span class="sex">'+res.item[i].user_mes.sex+'</span><span class="year ml-5">'+res.item[i].user_mes.year+'<span><p>上次登陆时间：<span class="time">2017-10-17</span></p></div></div></div></div></li>');
	   ...
	   $('.pagination-lump .first').click(function(){
	   	...
	   	$.ajax({
			...
			dataType: "json",
            contentType : "application/json; charset=UTF-8",
			data:JSON.stringify(dangqianindex),
			// data:update_count, //每次加载最后一条的索引值
			success: function (res) {  
				...
				var i = 0;
				for( i = 0; i < len; i++){
					$('.left-content .content ul').append('<li class="clearfix"><div class="icon fl"><a href="javascript:void(0);"><img src='+res.item[i].img+' id='+res.item[i].user_mes.id+'></a></div><div class="fl"><div class="clearfix tt"><span class="nor fl">'+res.item[i].topic+'</span><a class="title fl" href="#">'+res.item[i].tt+'</a></div><div class="txt"><p><span class="w">'+res.item[i].user_name+'</span>&nbsp;发表于：<span class="time">'+res.item[i].start_time+'</span>&nbsp;最新回复：<span class="new">'+res.item[i].lastest_time+'</span></p></div></div><div class="fr mt-10 mr-10"><span class="comment">'+res.item[i].comment+'</span></div><div style="display: none;" class="tooltip"><div id='+"tooltip"+i+'><div class="clearfix"><div class="img-box fl"><img src='+res.item[i].img+'><div class="talk clearfix"><a href="#" class="fl add-btn">+添加</a></div></div><div class="h-102 fl"><p class="name">'+res.item[i].user_mes.name+'</p><p class="school">'+res.item[i].user_mes.school+'</p><span class="sex">'+res.item[i].user_mes.sex+'</span><span class="year ml-5">'+res.item[i].user_mes.year+'<span><p>上次登陆时间：<span class="time">2017-10-17</span></p></div></div></div></div></li>');
					// top 表示是否为置顶
					if(res.item[i].top){
						$('.left-content li span.nor').removeClass("nor").addClass("kind");
						$('.left-content li a.title').addClass("light");
	...
	$('.final_submit').click(function(){
		...
		var send_plus = {
			...
			topic : $('.editor-lump select').val(),
			tt : $('.editor-lump .ipt').val(),
			txt : $('.editor-lump textarea').val(),
		}
